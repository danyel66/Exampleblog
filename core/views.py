...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        send_mail(subject, message, 'danison66@gmail.com', [cd['to']])
        sent = True
    else:
        form = EmailPostForm()
    return render(request, 'core/share.html', {'post': post,
                                               'form': form,
                                               'sent': sent})
...
def post_search(request):
    ...
    return render(request, 'core/search.html', {'form': form, 'query': query,
                                                'results': results})
